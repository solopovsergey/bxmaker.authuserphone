# Добавление поля дата рождения

В данном случае не приведен обработик на серверной стороне, язвковые файлы и прочее. Это лишь пример как добавить другое поле, прикрутить к нему маску.
...
> методы должны быть определены через function как для mount и beforeUnmount
